--*************************************************************************--
-- Title: Assignment07
-- Author: Padma Bhamidipati
-- Desc: This file demonstrates how to use built-in and user-defined Functions to get the data represented in a desired format, in reporting for example
-- Change Log: When,Who,What
-- 2023-11-29,PBhamidipati,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_PBhamidipati')
	 Begin 
	  Alter Database [Assignment07DB_PBhamidipati] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_PBhamidipati;
	 End
	Create Database Assignment07DB_PBhamidipati;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_PBhamidipati;
